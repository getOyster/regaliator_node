...
function Regaliator(apiHost, apiKey, secret, version) {
  ...
  this.xsinglePay = function (content) {
    return this.request.post("/single/pay", content);
  };
  ...
  this.xcancelTransaction = function (params) {
    return this.request.post("/transaction/cancel", params);
  };
}
